<?php
    switch($_GET["op"]){
        case "listar":
            $url='http://localhost:5000/web/controller/ControllerProducto.php?op=GetAll';
        ...
        case "guardar":
            $url = "http://localhost:5000/web/controller/ControllerProducto.php?op=Insert";
            $data = array(
        ...
        case "actualizar":
            $url = "http://localhost:5000/web/controller/ControllerProducto.php?op=Update";
            $data = array(
                "id" => $_POST["id"],
                "nombrep" => $_POST["nombrep"],
                "descripcion" => $_POST["descripcion"],
        ...
        case "mostrar":
            $url = "http://localhost:5000/web/controller/ControllerProducto.php?op=GetId";
            $data = array(
                "id" => $_POST["id"]
            );
            $payload = json_encode($data);
        ...
        case "eliminar":
            $url = "http://localhost:5000/web/controller/ControllerProducto.php?op=Delete";
            $data = array(
                "id" => $_POST["id"]
            );
            $payload = json_encode($data);
        ...
        case "activar":
            $url = "http://localhost:5000/web/controller/ControllerProducto.php?op=Activar";
            $data = array(
                "id" => $_POST["id"],
                "estado" => $_POST["estado"],
            );
        ...
        case "buscarcategoria":
            $url = "http://localhost:5000/web/controller/ControllerProducto.php?op=GetCategoria";
            $data = array(
                "categoria" => $_POST["categoria"]
            );
            $payload = json_encode($data);
